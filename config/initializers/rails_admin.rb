# RailsAdmin config file. Generated on August 30, 2012 20:28
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = [Art, MainMenu, Text]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Art, MainMenu, Text]
  ...
  #     configure :destination, :string   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
